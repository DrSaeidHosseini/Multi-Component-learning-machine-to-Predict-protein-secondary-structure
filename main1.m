...
save('finalLab.mat','finalLab');   
save('finalLab1.mat','finalLab1');
save('finalLab2','finalLab2');
save('finalLab3.mat','finalLab3');
save('finalLab4','finalLab4');
save('finalLab5','finalLab5');
save('finalAcc.mat','finalAcc');
